...
public class DarkSkyWeather implements WeatherService {
    ...
    public String getWeather() {
        ...
        try {
            //open url connection to darksky, GET request for weather info
            ...
            in.close();
            //grab info from returned json in JSONObjects/JSONArrays
            ...
            ex.printStackTrace();
            to_return = "Unable to fetch weather forecast";
        }
